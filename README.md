...
| `cognitivetree/llm/caching.py` | `CompletionCache` (shareable bounded LRU store) and `CachingLlmClient`: replay of identical deterministic requests; hits report zero tokens |
